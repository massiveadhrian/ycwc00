    ...
    <div class="page-container">
        ...
        <div style="display: flex; align-items: center; gap: var(--space-4);">
          ...
          <div class="subject-detail-info">
            <div style="display: flex; align-items: center; gap: var(--space-3);">
              ...
              ${isCustom ? `<span class="badge" style="background: rgba(var(--color-primary-rgb), 0.15); color: var(--color-primary-light);">Custom</span>` : ''}
            </div>
      ...
      ` : `
        <div class="card" style="text-align: center; padding: var(--space-8); color: var(--color-text-secondary);">
          <p>No activity yet for ${escapeHtml(subject.name)}. Take a quiz or practice exam to start tracking your progress!</p>
        </div>
      `}
        ...
        <div class="modal-overlay" id="detail-delete-modal" style="display: none;">
          <div class="modal delete-modal">
            ...
            <p style="color: var(--color-text-secondary); line-height: var(--leading-relaxed); margin-bottom: var(--space-6);">
              Are you sure you want to delete <strong>${escapeHtml(subject.name)}</strong>? This action will permanently remove the course and cannot be undone.
            </p>
            <div style="display: flex; gap: var(--space-3); justify-content: flex-end;">
              <button class="btn btn-secondary" id="detail-delete-cancel">Cancel</button>
