    ...
    <div class="continue-session-card animate-item">
      <div class="continue-session-content">
        ...
        <div class="continue-session-info">
          <div class="continue-session-title">${isExam ? t('dashboard.continueExam') : t('dashboard.continueQuiz')}</div>
          <div class="continue-session-subject">${escapeHtml(subject)}</div>
          <div class="continue-session-meta">
            <span>${t('dashboard.question')} ${currentQ} / ${totalQuestions}</span>
            <span>•</span>
            <span>${percent}% ${t('dashboard.complete')}</span>
      ...
      <div class="continue-session-actions">
        <button class="btn btn-primary" id="continue-session-btn">${isExam ? t('dashboard.resume') : t('dashboard.continue')}</button>
        <button class="continue-session-discard" id="discard-session-btn" title="${t('dashboard.discardSession')}">✕</button>
      </div>
    </div>
  `;
}
