      ...
      <div class="modal-overlay" id="delete-subject-modal" style="display: none;">
        <div class="modal delete-modal">
          ...
          <p style="color: var(--color-text-secondary); line-height: var(--leading-relaxed); margin-bottom: var(--space-6);">
            ${t('subjectDetail.deleteModalDesc')} <strong id="delete-course-name" style="color: var(--color-text);"></strong>
          </p>
          <div style="display: flex; gap: var(--space-3); justify-content: flex-end;">
            <button class="btn btn-secondary" id="delete-modal-cancel-btn">${t('subjects.cancel')}</button>
